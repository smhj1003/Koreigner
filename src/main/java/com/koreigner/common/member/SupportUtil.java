...
public class SupportUtil {
	...
	public static UserVO makeAccountDataVO(String mem_id, String mem_pw){
		UserVO userVo = new UserVO();
		userVo.setMem_id(mem_id);
		userVo.setMem_pw(mem_pw);
		userVo.setSecretKey("non use this project");
		return userVo;
	}
