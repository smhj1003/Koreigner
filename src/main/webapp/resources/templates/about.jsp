...
<head>
    ...
    <link rel="apple-touch-icon" href="${contextPath}/apple-touch-icon.png">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="${contextPath}/images/logo.png" class="logo" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item"><a class="nav-link" href="${contextPath}/index.jsp">Home</a></li>
                        <li class="nav-item active"><a class="nav-link" href="about.html">About Us</a></li>
                        <li class="dropdown">
                            <a href="#" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">SHOP</a>
                            <ul class="dropdown-menu">
								<li><a href="${contextPath}/shop.jsp">Sidebar Shop</a></li>
								<li><a href="${contextPath}/shop-detail.html">Shop Detail</a></li>
                                <li><a href="${contextPath}/cart.html">Cart</a></li>
                                <li><a href="${contextPath}/checkout.html">Checkout</a></li>
                                <li><a href="${contextPath}/my-account.html">My Account</a></li>
                                <li><a href="${contextPath}/wishlist.html">Wishlist</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="${contextPath}/gallery.html">Gallery</a></li>
                        <li class="nav-item"><a class="nav-link" href="${contextPath}/contact-us.html">Contact Us</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        <li>
                            <a href="#" class="photo"><img src="${contextPath}/images/img-pro-01.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Delica omtantur </a></h6>
                            <p>1x - <span class="price">$80.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="${contextPath}/images/img-pro-02.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Omnes ocurreret</a></h6>
                            <p>1x - <span class="price">$60.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="${contextPath}/images/img-pro-03.jpg" class="cart-thumb" alt="" /></a>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="${contextPath}/images/about-img.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row my-4">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="${contextPath}/images/img-1.jpg" alt="" />
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="${contextPath}/images/img-2.jpg" alt="" />
                            <div class="team-content">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="${contextPath}/images/img-3.jpg" alt="" />
                            <div class="team-content">
